...
export default class LiveTvRelated extends React.Component {
  state = {
    isFetching: false,
    item: {
      rate: 1,
  ...
  render() {
    ...
    const liveTvId = this.props.routeParams.liveTvId;
        ...
        :
          ...
          >
            ...
            <Autocomplete
              type="live-tv"
              label="Live TV 추가"
              placeholder="Live TV 이름을 입력해주세요"
              items={relateContents.concat({_id: liveTvId})}
